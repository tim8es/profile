(() => {
  ...
  const ui = {
    en: {
      ...
      deep:{
        audit:[["Problem","What problem did the audit project solve?"],["Workflow","How was the audit process changed?"],["Role","What was Timur responsible for?"],["Result","What measurable result did it produce?"],["Verification","How was the change validated?"],["Limits","What was researched but not implemented?"],["Decision","Why was the audit project built this way?"],["Alternatives","What alternatives were considered for the audit project?"],["Challenge","What was the hardest part of the audit project?"],["Production-ready","What is already production-ready in the audit project?"],["Почему так?","Почему проект аудита сделан именно так?"],["Альтернативы","Какие варианты рассматривались для проект аудита?"],["Сложность","Что было самым сложным в проект аудита?"],["Production-ready","Что в проект аудита уже production-ready?"]],
        crm:[["Problem","What problem did the CRM project solve?"],["Workflow","How did CRM delivery work?"],["Role","What was Timur responsible for?"],["Result","What was delivered and at what scale?"],["Verification","How was delivery reliability handled?"],["Limits","What does this case not claim?"],["Decision","Why was the CRM project built this way?"],["Alternatives","What alternatives were considered for the CRM project?"],["Challenge","What was the hardest part of the CRM project?"],["Production-ready","What is already production-ready in the CRM project?"],["Почему так?","Почему CRM-проект сделан именно так?"],["Альтернативы","Какие варианты рассматривались для CRM-проект?"],["Сложность","Что было самым сложным в CRM-проект?"],["Production-ready","Что в CRM-проект уже production-ready?"]],
        bi:[["Problem","What reporting problem did the dashboards solve?"],["Workflow","How were the dashboards built and used?"],["Role","What did Timur do himself?"],["Result","What measurable result did the dashboards produce?"],["Verification","How was the effect validated?"],["Limits","What does the project not claim?"],["Decision","Why was the BI dashboards built this way?"],["Alternatives","What alternatives were considered for the BI dashboards?"],["Challenge","What was the hardest part of the BI dashboards?"],["Production-ready","What is already production-ready in the BI dashboards?"],["Почему так?","Почему BI-дашборды сделан именно так?"],["Альтернативы","Какие варианты рассматривались для BI-дашборды?"],["Сложность","Что было самым сложным в BI-дашборды?"],["Production-ready","Что в BI-дашборды уже production-ready?"]],
        invoice:[["Problem","What problem did Invoice Automation solve?"],["Workflow","How did Invoice Automation work?"],["Role","What did Timur implement?"],["Result","What was the measured result?"],["Verification","How was the workflow validated?"],["Limits","What was built but not launched in production?"],["Decision","Why was Invoice Automation built this way?"],["Alternatives","What alternatives were considered for Invoice Automation?"],["Challenge","What was the hardest part of Invoice Automation?"],["Production-ready","What is already production-ready in Invoice Automation?"],["Почему так?","Почему Invoice Automation сделан именно так?"],["Альтернативы","Какие варианты рассматривались для Invoice Automation?"],["Сложность","Что было самым сложным в Invoice Automation?"],["Production-ready","Что в Invoice Automation уже production-ready?"]],
        book:[["Problem","What problem does Book Translator solve?"],["Workflow","How does a book move through the workflow?"],["Role","What did Timur design in Book Translator?"],["Result","What does the durable workspace enable?"],["Verification","How is source and translation integrity checked?"],["Limits","What are the format and persistence limitations?"],["Decision","Why was Book Translator built this way?"],["Alternatives","What alternatives were considered for Book Translator?"],["Challenge","What was the hardest part of Book Translator?"],["Production-ready","What is already production-ready in Book Translator?"],["Почему так?","Почему Book Translator сделан именно так?"],["Альтернативы","Какие варианты рассматривались для Book Translator?"],["Сложность","Что было самым сложным в Book Translator?"],["Production-ready","Что в Book Translator уже production-ready?"]],
        video:[["Problem","What production problem does the AI Video Pipeline solve?"],["Workflow","How does the pipeline work end to end?"],["Role","What did Timur design?"],["Result","What artifacts does the pipeline produce?"],["Verification","How are weak outputs and failures handled?"],["Limits","Why is publishing outside the base workflow?"],["Decision","Why was AI Video Pipeline built this way?"],["Alternatives","What alternatives were considered for AI Video Pipeline?"],["Challenge","What was the hardest part of AI Video Pipeline?"],["Production-ready","What is already production-ready in AI Video Pipeline?"],["Почему так?","Почему AI Video Pipeline сделан именно так?"],["Альтернативы","Какие варианты рассматривались для AI Video Pipeline?"],["Сложность","Что было самым сложным в AI Video Pipeline?"],["Production-ready","Что в AI Video Pipeline уже production-ready?"]],
        tube:[["Problem","What problem does TubeScore solve?"],["Workflow","How does TubeScore work?"],["Role","What did Timur build?"],["Result","What is the current product result?"],["Verification","How does TubeScore avoid bad matches?"],["Limits","What are the current data-source limitations?"],["Decision","Why was TubeScore built this way?"],["Alternatives","What alternatives were considered for TubeScore?"],["Challenge","What was the hardest part of TubeScore?"],["Production-ready","What is already production-ready in TubeScore?"],["Почему так?","Почему TubeScore сделан именно так?"],["Альтернативы","Какие варианты рассматривались для TubeScore?"],["Сложность","Что было самым сложным в TubeScore?"],["Production-ready","Что в TubeScore уже production-ready?"]],
        lightning:[["Problem","What job-search problem does HH Lightning solve?"],["Workflow","How does HH Lightning work?"],["Role","What does Timur own in the product?"],["Result","What functionality is implemented?"],["Verification","What affects HH Lightning reliability?"],["Limits","What metrics are not claimed yet?"],["Decision","Why was HH Lightning built this way?"],["Alternatives","What alternatives were considered for HH Lightning?"],["Challenge","What was the hardest part of HH Lightning?"],["Production-ready","What is already production-ready in HH Lightning?"],["Почему так?","Почему HH Lightning сделан именно так?"],["Альтернативы","Какие варианты рассматривались для HH Lightning?"],["Сложность","Что было самым сложным в HH Lightning?"],["Production-ready","Что в HH Lightning уже production-ready?"]],
        market:[["Problem","What market-research problem does Job Market Scanner solve?"],["Workflow","How does data move from hh.ru to the website?"],["Role","What did Timur design?"],["Result","What is the current product result?"],["Verification","How does it protect data quality?"],["Limits","How should dataset freshness be interpreted?"],["Decision","Why was Job Market Scanner built this way?"],["Alternatives","What alternatives were considered for Job Market Scanner?"],["Challenge","What was the hardest part of Job Market Scanner?"],["Production-ready","What is already production-ready in Job Market Scanner?"],["Почему так?","Почему Job Market Scanner сделан именно так?"],["Альтернативы","Какие варианты рассматривались для Job Market Scanner?"],["Сложность","Что было самым сложным в Job Market Scanner?"],["Production-ready","Что в Job Market Scanner уже production-ready?"]],
        feed:[["Problem","What problem does FeedPulse solve?"],["Workflow","How does FeedPulse work?"],["Role","What did Timur design?"],["Result","What does FeedPulse provide to agents?"],["Verification","How does it handle failures and state safely?"],["Limits","What does FeedPulse deliberately not do?"],["Decision","Why was FeedPulse built this way?"],["Alternatives","What alternatives were considered for FeedPulse?"],["Challenge","What was the hardest part of FeedPulse?"],["Production-ready","What is already production-ready in FeedPulse?"],["Почему так?","Почему FeedPulse сделан именно так?"],["Альтернативы","Какие варианты рассматривались для FeedPulse?"],["Сложность","Что было самым сложным в FeedPulse?"],["Production-ready","Что в FeedPulse уже production-ready?"]]
      }
    },
    ru: {
