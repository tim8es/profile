(() => {
  ...
  const ui = {
    en: {
      ...
      deep:{
        audit:[["Why? ","What problem does the audit project solve?"],["How it works","How does the audit project work?"],["Timur's role","What exactly did Timur do in the audit project?"],["Result","What was the outcome of the audit project?"],["Verification","How was the audit project checked in practice?"],["Limits","What is still limited or unfinished in the audit project?"],["Why this way?","Why was the audit project built this way?"],["Other options","What other options were considered for the audit project?"],["Hardest part","What was the hardest part of the audit project?"],["Already working","What already works in the audit project?"]],
        crm:[["Why? ","What problem does the CRM project solve?"],["How it works","How does the CRM project work?"],["Timur's role","What exactly did Timur do in the CRM project?"],["Result","What was the outcome of the CRM project?"],["Verification","How was the CRM project checked in practice?"],["Limits","What is still limited or unfinished in the CRM project?"],["Why this way?","Why was the CRM project built this way?"],["Other options","What other options were considered for the CRM project?"],["Hardest part","What was the hardest part of the CRM project?"],["Already working","What already works in the CRM project?"]],
        bi:[["Why? ","What problem does the dashboards solve?"],["How it works","How does the dashboards work?"],["Timur's role","What exactly did Timur do in the dashboards?"],["Result","What was the outcome of the dashboards?"],["Verification","How was the dashboards checked in practice?"],["Limits","What is still limited or unfinished in the dashboards?"],["Why this way?","Why was the dashboards built this way?"],["Other options","What other options were considered for the dashboards?"],["Hardest part","What was the hardest part of the dashboards?"],["Already working","What already works in the dashboards?"]],
        invoice:[["Why? ","What problem does Invoice Automation solve?"],["How it works","How does Invoice Automation work?"],["Timur's role","What exactly did Timur do in Invoice Automation?"],["Result","What was the outcome of Invoice Automation?"],["Verification","How was Invoice Automation checked in practice?"],["Limits","What is still limited or unfinished in Invoice Automation?"],["Why this way?","Why was Invoice Automation built this way?"],["Other options","What other options were considered for Invoice Automation?"],["Hardest part","What was the hardest part of Invoice Automation?"],["Already working","What already works in Invoice Automation?"]],
        book:[["Why? ","What problem does Book Translator solve?"],["How it works","How does Book Translator work?"],["Timur's role","What exactly did Timur do in Book Translator?"],["Result","What was the outcome of Book Translator?"],["Verification","How was Book Translator checked in practice?"],["Limits","What is still limited or unfinished in Book Translator?"],["Why this way?","Why was Book Translator built this way?"],["Other options","What other options were considered for Book Translator?"],["Hardest part","What was the hardest part of Book Translator?"],["Already working","What already works in Book Translator?"]],
        video:[["Why? ","What problem does AI Video Pipeline solve?"],["How it works","How does AI Video Pipeline work?"],["Timur's role","What exactly did Timur do in AI Video Pipeline?"],["Result","What was the outcome of AI Video Pipeline?"],["Verification","How was AI Video Pipeline checked in practice?"],["Limits","What is still limited or unfinished in AI Video Pipeline?"],["Why this way?","Why was AI Video Pipeline built this way?"],["Other options","What other options were considered for AI Video Pipeline?"],["Hardest part","What was the hardest part of AI Video Pipeline?"],["Already working","What already works in AI Video Pipeline?"]],
        tube:[["Why? ","What problem does TubeScore solve?"],["How it works","How does TubeScore work?"],["Timur's role","What exactly did Timur do in TubeScore?"],["Result","What was the outcome of TubeScore?"],["Verification","How was TubeScore checked in practice?"],["Limits","What is still limited or unfinished in TubeScore?"],["Why this way?","Why was TubeScore built this way?"],["Other options","What other options were considered for TubeScore?"],["Hardest part","What was the hardest part of TubeScore?"],["Already working","What already works in TubeScore?"]],
        lightning:[["Why? ","What problem does HH Lightning solve?"],["How it works","How does HH Lightning work?"],["Timur's role","What exactly did Timur do in HH Lightning?"],["Result","What was the outcome of HH Lightning?"],["Verification","How was HH Lightning checked in practice?"],["Limits","What is still limited or unfinished in HH Lightning?"],["Why this way?","Why was HH Lightning built this way?"],["Other options","What other options were considered for HH Lightning?"],["Hardest part","What was the hardest part of HH Lightning?"],["Already working","What already works in HH Lightning?"]],
        market:[["Why? ","What problem does Job Market Scanner solve?"],["How it works","How does Job Market Scanner work?"],["Timur's role","What exactly did Timur do in Job Market Scanner?"],["Result","What was the outcome of Job Market Scanner?"],["Verification","How was Job Market Scanner checked in practice?"],["Limits","What is still limited or unfinished in Job Market Scanner?"],["Why this way?","Why was Job Market Scanner built this way?"],["Other options","What other options were considered for Job Market Scanner?"],["Hardest part","What was the hardest part of Job Market Scanner?"],["Already working","What already works in Job Market Scanner?"]],
        feed:[["Why? ","What problem does FeedPulse solve?"],["How it works","How does FeedPulse work?"],["Timur's role","What exactly did Timur do in FeedPulse?"],["Result","What was the outcome of FeedPulse?"],["Verification","How was FeedPulse checked in practice?"],["Limits","What is still limited or unfinished in FeedPulse?"],["Why this way?","Why was FeedPulse built this way?"],["Other options","What other options were considered for FeedPulse?"],["Hardest part","What was the hardest part of FeedPulse?"],["Already working","What already works in FeedPulse?"]]
      }
    },
    ru: {
      ...
      deep:{
        audit:[["Зачем нужен?","Какую проблему решает проект аудита?"],["Как работает?","Как работает проект аудита?"],["Роль Тимура","Что именно сделал Тимур в проект аудита?"],["Результат","Что получилось в итоге в проект аудита?"],["Проверка","Как проверяли, что проект аудита работает как нужно?"],["Ограничения","Что в проект аудита пока ограничено или не сделано?"],["Почему так?","Почему проект аудита сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для проект аудита?"],["Самое сложное","Что было самым сложным в проект аудита?"],["Что уже работает","Что в проект аудита уже реально работает?"]],
        crm:[["Зачем нужен?","Какую проблему решает CRM-проект?"],["Как работает?","Как работает CRM-проект?"],["Роль Тимура","Что именно сделал Тимур в CRM-проект?"],["Результат","Что получилось в итоге в CRM-проект?"],["Проверка","Как проверяли, что CRM-проект работает как нужно?"],["Ограничения","Что в CRM-проект пока ограничено или не сделано?"],["Почему так?","Почему CRM-проект сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для CRM-проект?"],["Самое сложное","Что было самым сложным в CRM-проект?"],["Что уже работает","Что в CRM-проект уже реально работает?"]],
        bi:[["Зачем нужен?","Какую проблему решает дашборды?"],["Как работает?","Как работает дашборды?"],["Роль Тимура","Что именно сделал Тимур в дашборды?"],["Результат","Что получилось в итоге в дашборды?"],["Проверка","Как проверяли, что дашборды работает как нужно?"],["Ограничения","Что в дашборды пока ограничено или не сделано?"],["Почему так?","Почему дашборды сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для дашборды?"],["Самое сложное","Что было самым сложным в дашборды?"],["Что уже работает","Что в дашборды уже реально работает?"]],
        invoice:[["Зачем нужен?","Какую проблему решает Invoice Automation?"],["Как работает?","Как работает Invoice Automation?"],["Роль Тимура","Что именно сделал Тимур в Invoice Automation?"],["Результат","Что получилось в итоге в Invoice Automation?"],["Проверка","Как проверяли, что Invoice Automation работает как нужно?"],["Ограничения","Что в Invoice Automation пока ограничено или не сделано?"],["Почему так?","Почему Invoice Automation сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для Invoice Automation?"],["Самое сложное","Что было самым сложным в Invoice Automation?"],["Что уже работает","Что в Invoice Automation уже реально работает?"]],
        book:[["Зачем нужен?","Какую проблему решает Book Translator?"],["Как работает?","Как работает Book Translator?"],["Роль Тимура","Что именно сделал Тимур в Book Translator?"],["Результат","Что получилось в итоге в Book Translator?"],["Проверка","Как проверяли, что Book Translator работает как нужно?"],["Ограничения","Что в Book Translator пока ограничено или не сделано?"],["Почему так?","Почему Book Translator сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для Book Translator?"],["Самое сложное","Что было самым сложным в Book Translator?"],["Что уже работает","Что в Book Translator уже реально работает?"]],
        video:[["Зачем нужен?","Какую проблему решает AI Video Pipeline?"],["Как работает?","Как работает AI Video Pipeline?"],["Роль Тимура","Что именно сделал Тимур в AI Video Pipeline?"],["Результат","Что получилось в итоге в AI Video Pipeline?"],["Проверка","Как проверяли, что AI Video Pipeline работает как нужно?"],["Ограничения","Что в AI Video Pipeline пока ограничено или не сделано?"],["Почему так?","Почему AI Video Pipeline сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для AI Video Pipeline?"],["Самое сложное","Что было самым сложным в AI Video Pipeline?"],["Что уже работает","Что в AI Video Pipeline уже реально работает?"]],
        tube:[["Зачем нужен?","Какую проблему решает TubeScore?"],["Как работает?","Как работает TubeScore?"],["Роль Тимура","Что именно сделал Тимур в TubeScore?"],["Результат","Что получилось в итоге в TubeScore?"],["Проверка","Как проверяли, что TubeScore работает как нужно?"],["Ограничения","Что в TubeScore пока ограничено или не сделано?"],["Почему так?","Почему TubeScore сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для TubeScore?"],["Самое сложное","Что было самым сложным в TubeScore?"],["Что уже работает","Что в TubeScore уже реально работает?"]],
        lightning:[["Зачем нужен?","Какую проблему решает HH Lightning?"],["Как работает?","Как работает HH Lightning?"],["Роль Тимура","Что именно сделал Тимур в HH Lightning?"],["Результат","Что получилось в итоге в HH Lightning?"],["Проверка","Как проверяли, что HH Lightning работает как нужно?"],["Ограничения","Что в HH Lightning пока ограничено или не сделано?"],["Почему так?","Почему HH Lightning сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для HH Lightning?"],["Самое сложное","Что было самым сложным в HH Lightning?"],["Что уже работает","Что в HH Lightning уже реально работает?"]],
        market:[["Зачем нужен?","Какую проблему решает Job Market Scanner?"],["Как работает?","Как работает Job Market Scanner?"],["Роль Тимура","Что именно сделал Тимур в Job Market Scanner?"],["Результат","Что получилось в итоге в Job Market Scanner?"],["Проверка","Как проверяли, что Job Market Scanner работает как нужно?"],["Ограничения","Что в Job Market Scanner пока ограничено или не сделано?"],["Почему так?","Почему Job Market Scanner сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для Job Market Scanner?"],["Самое сложное","Что было самым сложным в Job Market Scanner?"],["Что уже работает","Что в Job Market Scanner уже реально работает?"]],
        feed:[["Зачем нужен?","Какую проблему решает FeedPulse?"],["Как работает?","Как работает FeedPulse?"],["Роль Тимура","Что именно сделал Тимур в FeedPulse?"],["Результат","Что получилось в итоге в FeedPulse?"],["Проверка","Как проверяли, что FeedPulse работает как нужно?"],["Ограничения","Что в FeedPulse пока ограничено или не сделано?"],["Почему так?","Почему FeedPulse сделали именно таким способом?"],["Другие варианты","Какие другие варианты рассматривали для FeedPulse?"],["Самое сложное","Что было самым сложным в FeedPulse?"],["Что уже работает","Что в FeedPulse уже реально работает?"]]
      }
    }
  };
  ...
  const answers = {
    en:{
      ...
      identity:"Timur Dautov has more than 10 years of professional experience. He started in operations and team management, then moved into project and product work, analytics, automation and building software with AI.",
      ...
      background:"Timur has more than 10 years of professional experience. At Skyeng he worked with support operations, teams, processes and analytics; at SPIKS he managed development of a B2B loyalty product; at OpiniQ he worked on automation and AI experiments. More recently, he has been building small products and automation himself.",
      backgroundMore:"His experience is broader than classic project management: team leadership, process improvement, requirements, delivery, analytics, automation and building small software products. Verified scale includes 200+ redesigned processes at Skyeng, 17 end-to-end projects at SPIKS and research of 40+ AI use cases at OpiniQ.",
      ...
      hire:"A practical reason to work with Timur is the combination of delivery discipline and hands-on implementation. He can clarify a vague workflow, turn it into requirements and priorities, coordinate people when needed, and also build or automate the first working version himself. Evidence includes leading a 23-person team, managing delivery of a multi-application B2B CRM program, cutting reporting work by about 70%, and shipping automation/product prototypes.",
      strengths:"Timur is strongest when a problem is still unclear. He can understand how the work happens today, decide what should change, organize delivery and, when useful, build the first working version himself.",
      management:"Timur has direct management experience. He led a remote team of 23 specialists plus a trainer, handling planning, goals, one-to-one meetings, reporting, hiring, onboarding, bonuses and process improvement. In project roles he also coordinated technical teams of up to about 30 people.",
      leadership:"His management style is based on clear responsibility, understandable goals and early discussion of risks. He prefers giving people autonomy instead of micromanaging them or filling the calendar with meetings.",
      b2b:"His main B2B product example is a Loyalty CRM at SPIKS: a SaaS/on-premise ecosystem with four web applications, two mobile applications, backend, PostgreSQL, payments and external integrations. Timur handled requirements, backlog, planning, priorities, risks, client communication and delivery, across a multi-application product scope.",
      ...
      reliability:"Timur tries to make automation predictable rather than magical. Important data is checked, failures are visible, interrupted work can often continue, and risky actions such as publishing stay under human control.",
      currentFocus:"His current focus is practical AI products and automation: browser tools, small web products, agent utilities and workflows. The goal is not to add AI everywhere, but to use it where it actually removes work or enables something useful.",
      ...
      technicalDepth:"Timur is not positioning himself as a narrow senior developer. His strength is being technical enough to build prototypes, connect services, work with data, debug integrations and automate real processes instead of stopping at requirements.",
      ...
      scope:"Useful scale markers: 23 assessors plus a trainer in direct team leadership; cross-functional teams up to about 30 people; 17 full-cycle projects at SPIKS; BI reporting across 20 products; more than 200 process redesigns at Skyeng; and delivery of a multi-application B2B CRM ecosystem.",
      ...
      decisionMaking:"He usually starts with the problem, not the technology. First he narrows the task, defines what success should look like, builds the smallest useful version and only adds complexity after seeing what actually breaks or helps.",
      collaboration:"He has worked with business users, operations teams, developers, technical leads, CTOs and clients. One of his useful skills is translating business needs into something a technical team can actually build.",
      whatProblems:"He is most useful when a process is messy, repetitive or spread across several tools, or when a team needs a working MVP quickly. He looks for the smallest change that removes real friction and can be measured.",
      ...
      skills:"His skills combine product work, process improvement, project delivery, analytics, automation and software prototyping. He can move from understanding a problem to a working prototype or a real automated process.",
      skillsMore:"The profile is intentionally broad: product and project management, process improvement, analytics, connecting different services, browser automation and building AI-assisted tools.",
      ...
      financialImpact:"There is no verified portfolio figure for revenue generated or money saved that can be attributed directly to Timur. The defensible evidence is operational: about 70% less reporting time, about 20% faster processing in a migrated workflow, invoice generation under 15 seconds, and responsibility for a CRM program across a multi-application CRM program.",
      ai:"Timur uses AI as part of real products and workflows, not just as a chat assistant. Examples include help with job applications, long-form book translation and automatic preparation of short videos.",
      aiMore:"He also builds tools around AI agents, such as FeedPulse. The common idea is simple: let AI handle the parts where judgment is useful, while ordinary code handles data, checks and repeatable steps.",
      automation:"For automation, Timur first looks at the real work people do, finds repetitive steps and automates only those parts. Examples include invoice generation, reporting and moving manual work into a CRM.",
      product:"His product approach is simple: understand the user's real problem, cut the scope, build the smallest useful version, test it in reality and improve it from evidence.",
      projectsOverview:"The portfolio includes four work cases and six products Timur built or developed himself. They cover process improvement, analytics, automation, browser extensions, AI workflows and small developer tools.",
      ...
      project:{
        ...
        crm:{
          ...
          stats:"Verified scale markers: 4 web applications, 2 mobile applications, a shared backend and external integrations. The portfolio does not claim product revenue or user-count metrics.",
        ...
        bi:{
          ...
          workflow:"Operational data was pulled from source systems, the required metrics were calculated with SQL and shown in Yandex DataLens. The team could open the dashboards to see current values, compare changes over time and spot deviations without manually rebuilding reports.",
    ...
    ru:{
      ...
      identity:"Тимур Даутов — специалист с более чем 10 годами опыта. Он начинал с операционной работы и управления командой, затем перешёл в проекты и продукты, аналитику, автоматизацию и самостоятельную разработку решений с AI.",
      ...
      background:"У Тимура более 10 лет профессионального опыта. В Skyeng он работал с поддержкой, командами, процессами и аналитикой; в SPIKS управлял разработкой B2B-продукта; в OpiniQ занимался автоматизацией и экспериментами с AI. В последние годы он всё чаще сам собирает небольшие продукты и автоматизации.",
      backgroundMore:"Опыт шире классического проектного менеджмента: управление командой, улучшение процессов, требования, delivery, аналитика, автоматизация и создание небольших программных продуктов. Из подтверждённого масштаба — 200+ переработанных процессов в Skyeng, 17 проектов полного цикла в SPIKS и исследование 40+ AI-кейсов в OpiniQ.",
      ...
      hire:"Практическая причина работать с Тимуром — сочетание delivery-дисциплины и hands-on реализации. Он может разобрать неясный workflow, превратить его в требования и приоритеты, организовать людей, если это нужно, и сам собрать или автоматизировать первую работающую версию. Из подтверждённых примеров: команда 23+1, delivery много-компонентной B2B CRM, сокращение времени отчётности примерно на 70% и собственные automation/product-прототипы.",
      strengths:"Сильная сторона Тимура — работа с ещё неясными задачами. Он может разобраться, как всё устроено сейчас, понять, что нужно изменить, организовать работу и при необходимости сам собрать первую рабочую версию.",
      management:"У Тимура есть прямой опыт управления людьми. Он руководил удалённой командой из 23 специалистов и тренера: планировал работу, ставил цели, проводил личные встречи, нанимал и адаптировал сотрудников, занимался отчётностью и бонусами. В проектах также координировал технические команды примерно до 30 человек.",
      leadership:"В управлении Тимур предпочитает понятную ответственность, конкретные цели и раннее обсуждение рисков. Ему ближе автономия сотрудников, чем микроменеджмент и большое количество встреч.",
      b2b:"Главный B2B-пример — Loyalty CRM в SPIKS: SaaS/on-premise экосистема из четырёх web-приложений, двух mobile-приложений, backend, PostgreSQL, платежей и внешних интеграций. Тимур отвечал за требования, backlog, планирование, приоритеты, риски, коммуникацию с клиентом и delivery; delivery охватывал web, mobile, backend и внешние интеграции.",
      ...
      reliability:"Тимур старается делать автоматизацию предсказуемой, а не «магической». Важные данные проверяются, ошибки не скрываются, прерванную работу по возможности можно продолжить, а рискованные действия вроде публикации остаются под контролем человека.",
      currentFocus:"Сейчас Тимур в основном делает практические AI-продукты и автоматизации: браузерные инструменты, небольшие web-сервисы, утилиты для AI-агентов и рабочие процессы. AI используется только там, где он действительно даёт пользу.",
      ...
      technicalDepth:"Тимур не позиционирует себя как узкого senior-разработчика. Его технического уровня достаточно, чтобы самому собрать прототип, связать сервисы через API, работать с данными, находить ошибки и автоматизировать реальные процессы.",
      ...
      scope:"Несколько маркеров масштаба: 23 асессора + тренер в прямом управлении; cross-functional команды примерно до 30 человек; 17 full-cycle проектов в SPIKS; BI-отчётность для 20 продуктов; 200+ переработанных процессов в Skyeng; delivery много-компонентной B2B CRM-экосистемы.",
      ...
      decisionMaking:"Обычно он начинает не с технологии, а с проблемы. Сначала сужает задачу, определяет понятный критерий успеха, делает минимальную рабочую версию и усложняет её только после проверки на реальности.",
      collaboration:"Тимур работал с бизнесом, операционными командами, разработчиками, техническими лидами, CTO и клиентами. Он умеет переводить бизнес-задачи на язык, понятный технической команде, и обратно.",
      whatProblems:"Лучше всего ему подходят запутанные или повторяющиеся процессы, работа сразу в нескольких инструментах и задачи, где нужен быстрый рабочий MVP. Он ищет самое небольшое изменение, которое реально упростит работу и даст измеримый эффект.",
      ...
      skills:"Навыки Тимура объединяют продуктовую работу, улучшение процессов, delivery, аналитику, автоматизацию и создание прототипов. Он может пройти путь от понимания проблемы до работающего решения.",
      skillsMore:"Профиль широкий: product и project management, улучшение процессов, аналитика, интеграции между сервисами, browser automation и создание AI-инструментов.",
      ...
      impact:"Подтверждённые результаты: примерно −70% времени на регулярную отчётность, генерация инвойса менее чем за 15 секунд, около +20% к скорости обработки после переноса процесса в CRM, дашборды для 20 продуктов и delivery B2B CRM с web, mobile, backend и внешними интеграциями.",
      ...
      financialImpact:"Подтверждённой суммы выручки или экономии денег, которую корректно напрямую приписать Тимуру, в портфолио нет. Есть измеримые операционные результаты: около −70% времени на отчётность, около +20% скорости обработки процесса, инвойс менее чем за 15 секунд и ответственность за много-компонентную CRM-программу.",
      ai:"Тимур использует AI внутри реальных продуктов и рабочих процессов, а не только как чат. Например, AI помогает работать с вакансиями, переводить большие книги и автоматически готовить короткие видео.",
      aiMore:"Также он делает инструменты для AI-агентов, например FeedPulse. Общий принцип простой: AI решает задачи, где нужен анализ, а обычный код отвечает за данные, проверки и повторяемые действия.",
      automation:"В автоматизации Тимур сначала смотрит, как люди реально выполняют работу, находит повторяющиеся шаги и автоматизирует именно их. Примеры — генерация инвойсов, отчётность и перенос ручной работы в CRM.",
      product:"Продуктовый подход простой: понять реальную проблему пользователя, сократить объём до самого важного, сделать минимально полезную версию, проверить её на практике и только потом усложнять.",
      projectsOverview:"В портфолио четыре рабочих кейса и шесть продуктов, которые Тимур создавал или развивал сам. Они показывают опыт в улучшении процессов, аналитике, автоматизации, браузерных расширениях, AI и небольших технических инструментах.",
      ...
      project:{
        ...
        crm:{
          ...
          stats:"Подтверждённый масштаб: 4 web-приложения, 2 mobile-приложения, общий backend и внешние интеграции. Revenue и количество пользователей продукта в портфолио не заявлены.",
        ...
        bi:{
          ...
          workflow:"Рабочие данные собирались из операционных источников, нужные показатели рассчитывались через SQL и отображались в Yandex DataLens. Команда открывала готовые дашборды, чтобы видеть текущие значения, сравнивать их во времени и быстрее замечать отклонения без ручной подготовки отчётов.",
  ...
  const projectEvidence={
    en:{
      ...
      crm:{
        ...
        facts:["4 web apps","2 mobile apps","shared backend + integrations","SaaS + on-premise"],
    ...
    ru:{
      ...
      crm:{
        ...
        facts:["4 web-приложения","2 mobile-приложения","общий backend + интеграции","SaaS + on-premise"],
        artifacts:["multi-app product scope","release delivery"],
        links:[]
      },
      bi:{
  ...
  const projectPlain={
    ru:{
      ...
      crm:{
        ...
        stats:"Подтверждённый масштаб: 4 web-приложения, 2 mobile-приложения, общая серверная часть и внешние интеграции.",
      ...
      bi:{
        ...
        workflow:"Дашборды берут данные из рабочих источников, рассчитывают нужные показатели через SQL и показывают их в Yandex DataLens. Пользователь открывает готовый экран и сразу видит текущие значения, динамику и отклонения — без ручной сборки отчёта каждый раз.",
  ...
  function projectResult(lang,id,q,forcedIntent=null){
    ...
    if(forcedIntent){
      const exact={
        ...
        "project-challenge":simple.challenge||p.challenge,
        "project-readiness":simple.readiness||p.readiness,
        "project-evidence":lang==="ru"
          ?"Вот доступные проверяемые артефакты и схема реализации. Если публичного скриншота нет, показываю только реальные доступные доказательства."
          :"Here are the available verifiable artifacts and implementation evidence. If no public screenshot exists, only real accessible evidence is shown."
      };
      const text=exact[forcedIntent];
      if(text)return {lang,intent:forcedIntent,text,subject:id,project:id,evidence:forcedIntent==="project-evidence"?id:null};
    }
    const wants={
  ...
  async function askPortfolio(query,options={}){
    ...
    const forcedProject=options?.projectId;
    const forcedIntent=options?.intent;
    const result=forcedProject&&forcedIntent
      ?projectResult(lang,forcedProject,norm(text),forcedIntent)
      :classify(text);
